import { ModeToggle } from "@/shared/components/navigation/mode-toggle";

export function NavBar() {
	return (
		<div
			className="max-w-7xl mx-auto flex justify-between items-center my-5 px-5 lg:px-0"
			data-slot="nav-bar"
		>
			<div>
                <p>TSTB <span className="text-xs text-yellow-500 mr-0.5">alpha</span></p>
            </div>
			<div className="flex flex-row gap-2">
				<ModeToggle />
				<a
					href="https://github.com/dinogit/tanstack-table-builder"
                    target="_blank"
